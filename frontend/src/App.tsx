            ...
            <Stack direction="row" justify="space-between" align="center" mb={6}>
              <Heading size="lg" as="h1">PromptOps Dashboard</Heading>
                ...
                <Button onClick={toggleColorMode}>Toggle {colorMode === 'light' ? 'Dark' : 'Light'}</Button>
                    <Button colorScheme="red" variant="outline" onClick={async () => { await purgeAll(true); setPage(1); await load(); }}>Purge Data</Button>
                <Button onClick={() => setEssentials(e => !e)}>{essentials ? 'Advanced Mode' : 'Essentials Mode'}</Button>
                <Button colorScheme="teal" onClick={() => setShowHelp(true)}>Help</Button>
              </Stack>
            </Stack>
          </FuturisticGlow>
